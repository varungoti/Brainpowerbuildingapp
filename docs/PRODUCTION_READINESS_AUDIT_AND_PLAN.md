...
**Human-only tasks** (outside the repo): see **[OWNER_ACTION_CHECKLIST.md](./OWNER_ACTION_CHECKLIST.md)**. **Credentials & secrets:** **[SETUP_CREDENTIALS.md](./SETUP_CREDENTIALS.md)**. Environment matrix: **[ENVIRONMENTS.md](./ENVIRONMENTS.md)**. Incidents: **[INCIDENT_RUNBOOK.md](./INCIDENT_RUNBOOK.md)**.
